...
import imagine1 from "../../assets/img/image-sidebar-1.jpeg";
import imagine2 from "../../assets/img/sunrise-phu-quoc-island-ocean.jpg";
import imagine3 from "../../assets/img/image-sidebar-2.jpeg";
import imagine4 from "../../assets/img/image-sidebar-3.jpeg";
            ...
            <div className="fixed-plugin">
                <div id="fixedPluginClasses" className={this.props.fixedClasses}>
                    ...
                    <ul className="dropdown-menu">
                        <li className="header-title">Configuration<br/></li>
                        ...
                        {/* <li className="button-container">
                            <div className="">
                                ...
                                }<a href="https://www.creative-tim.com/product/light-bootstrap-dashboard-react" target="_blank" className="btn btn-success btn-block btn-fill">Download free!</a>
                            </div>
                        </li>
                        <li className="button-container">
                            <div className="">
                                {
                                    // eslint-disable-next-line
                                }<a href="https://www.creative-tim.com/product/light-bootstrap-dashboard-pro-react" target="_blank" className="btn btn-warning btn-block btn-fill">Buy Pro</a>
                            </div>
                        </li>
                        <li className="button-container">
                            <NavLink
