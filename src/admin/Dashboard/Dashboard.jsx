...
import { faServer,faSyncAlt,faUsers,faStoreAlt } from '@fortawesome/free-solid-svg-icons';
//import { faTwitterSquare,faGooglePlusSquare } from '@fortawesome/free-brands-svg-icons';

library.add(faServer,faSyncAlt,faUsers,faStoreAlt)
          ...
          <Row>
            <Col lg={3} sm={6}>
              <StatsCard
                ...
                statsText="Capacity"
                statsValue="105GB"
                statsIcon={<i className="fa fa-sync-alt" />}
            ...
            <Col lg={3} sm={6}>
              <StatsCard
                ...
                statsText="Errors"
                statsValue="23"
                statsIcon={<i className="fa fa-clock" />}
