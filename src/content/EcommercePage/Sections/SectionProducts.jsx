...
import Clearfix from "../../../components/Material-UI/Clearfix/Clearfix";

import suit1 from "../../../assets/img/product/suit-1.jpg";
import suit2 from "../../../assets/img/product/suit-2.jpg";
import suit3 from "../../../assets/img/product/suit-3.jpg";
import suit4 from "../../../assets/img/product/suit-4.jpg";
import suit5 from "../../../assets/img/product/suit-5.jpg";
import suit6 from "../../../assets/img/product/suit-6.jpg";
import color1 from "../../../assets/img/product/color1.jpg";
import color3 from "../../../assets/img/product/color3.jpg";
import color2 from "../../../assets/img/product/color2.jpg";
import dg3 from "../../../assets/img/product/dg3.jpg";
import dg1 from "../../../assets/img/product/dg1.jpg";

import styles from "../../../assets/jss/material-ui-react/views/ecommerceSections/productsStyle";
    ...
    return (
      <div className={classes.section}>
        <div className={classes.container}>
          <Typography variant="h3">Find what you need</Typography>
          <GridContainer>
            <GridItem md={3} sm={3}>
              <Card plain>
                <CardBody className={classes.cardBodyRefine}>
                  <Typography variant="h4" className={`${classes.cardTitle} ${classes.textLeft}`}>
                    Refine
